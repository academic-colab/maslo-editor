...
function help() {
	...
	In order to make a new project click the \"+ Add New Project\" button at the bottom of the list. Once you fill in the field with the name of your project click OK or press Enter.\
    <br/><br/>\
